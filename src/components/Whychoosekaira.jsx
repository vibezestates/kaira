  ...
  return (
    <section
      ...
      <div className='px-4 sm:px-8 md:px-16'>
        ...
        <h1 className="flex justify-center items-center font-secondary text-6xl md:text-6xl font-bold text-brown mb-10 justify">
  Why Choose Kaira
</h1>
